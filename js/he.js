...
(() => {
  ...
  const regexInvalidRawCodePoint =
  ...
  const invalidReferenceCodePoints = [
    ...
    156, 157, 158, 159, 64_976, 64_977, 64_978, 64_979, 64_980, 64_981, 64_982, 64_983, 64_984, 64_985, 64_986, 64_987, 64_988,
    64_989, 64_990, 64_991, 64_992, 64_993, 64_994, 64_995, 64_996, 64_997, 64_998, 64_999, 65_000, 65_001, 65_002, 65_003,
    65_004, 65_005, 65_006, 65_007, 65_534, 65_535, 131_070, 131_071, 196_606, 196_607, 262_142, 262_143, 327_678, 327_679,
    393_214, 393_215, 458_750, 458_751, 524_286, 524_287, 589_822, 589_823, 655_358, 655_359, 720_894, 720_895, 786_430,
    786_431, 851_966, 851_967, 917_502, 917_503, 983_038, 983_039, 1_048_574, 1_048_575, 1_114_110, 1_114_111,
  ];
  ...
  const codePointToSymbol = (codePoint, strict) => {
    ...
    if (codePoint > 0xff_ff) {
      codePoint -= 0x1_00_00;
      output += stringFromCharCode(((codePoint >>> 10) & 0x3ff) | 0xd8_00);
      codePoint = 0xdc_00 | (codePoint & 0x3ff);
    }
  ...
  var encode = (string, options) => {
    ...
    const { encodeEverything, useNamedReferences, allowUnsafeSymbols } = options;
    ...
    return (
      string
        ...
        .replace(regexAstralSymbols, ($0) => {
          ...
          const codePoint = (high - 0xd8_00) * 0x400 + low - 0xdc_00 + 0x1_00_00;
